...
dmg_package "iLife11.dmg" do
  ...
  volumes_dir "iLife11"
  dmg_name "iLife11"
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iLife11.dmg"
  checksum "50971f5cc0fafe30b783ff5af5663aece8ab124ca32945509283156d65346057"
  action :install
  type "pkg"
...
dmg_package "GarageBand6.0.5Update.dmg" do
  ...
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/GarageBand6.0.5Update.dmg"
...
dmg_package "iDVD7.1.2Update.dmg" do
  ...
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iDVD7.1.2Update.dmg"
...
dmg_package "iMovie9.0.8Update.dmg" do
  ...
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iMovie9.0.8Update.dmg"
...
dmg_package "iPhoto9.1Update.dmg" do
  ...
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iPhoto9.1Update.dmg"
...
dmg_package "iPhoto9.4.2Update.dmg" do
  ...
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iPhoto9.4.2Update.dmg"
...
dmg_package "iWeb304.dmg" do
  ...
  dmg_name "iWeb304"
  source "http://baratheon.class.wesleyan.edu/mac_os_x-10.8/apple_ilife-11/iWeb304.dmg"
