  ...
  def copy_dock_plist_for_user_template
      file "/System/Library/User Template/English.lproj/Preferences/com.apple.dock.plist" do
        owner "root"
        group "wheel"
        mode 0600
        action :delete
    ...
    #  execute "chown #{user.username}:staff /tmp/com.apple.dock.plist"
      execute "chmod 600 /tmp/com.apple.dock.plist"
      execute "cp /tmp/com.apple.dock.plist \"/System/Library/User Template/English.lproj/Preferences/com.apple.dock.plist\"" 
      execute "chown root:wheel \"/System/Library/User Template/English.lproj/Preferences/com.apple.dock.plist\""
  end
