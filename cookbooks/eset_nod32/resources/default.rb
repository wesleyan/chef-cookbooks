...
attribute :priveleged_users, :kind_of => String, :default => "root"
attribute :samples_enabled, :kind_of => Boolean, :default => true
...
attribute :av_scan_app_unwanted, :kind_of => Boolean, :default => true
