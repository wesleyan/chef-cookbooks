...
dmg_package "Logic Pro" do
  ...
  source "http://ims-chef.wesleyan.edu/os_x/apple_logic_pro/apple_logic_pro-9.1.8.dmg"
...
dmg_package "Logic Pro Additional Content" do
  ...
  source "http://ims-chef.wesleyan.edu/os_x/apple_logic_pro/apple_logic_pro_additional_content-9.dmg"
...
dmg_package "Logic Pro Audio Content" do
  ...
  source "http://ims-chef.wesleyan.edu/os_x/apple_logic_pro/apple_logic_pro_audio_content-9.dmg"
...
dmg_package "Logic Pro Jam Pack" do
  ...
  source "http://ims-chef.wesleyan.edu/os_x/apple_logic_pro/apple_logic_pro_jam_pack-9.dmg"
